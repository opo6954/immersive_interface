...
public class T1 : MonoBehaviour
{
    ...
    void MakeTestScenario()
    {
        ...
        button_green.instruction.SetContentWithContext("Stage 2", Information.Context.Title);
        ...
        joystick_nw.instruction.SetContentWithContext("Stage 3", Information.Context.Title);
        ...
        wheel_ccw.instruction.SetContentWithContext("Stage 5", Information.Context.Title);
